...
class Basic(commands.Cog):
    ...
    async def info(self, ctx):
        try:
            ...
            embed.add_field(name = "Invite", value = "Use [this](https://discord.com/api/oauth2/authorize?client_id=813350886675841065&permissions=388288&scope=bot) link to invite me in your server", inline = False)
